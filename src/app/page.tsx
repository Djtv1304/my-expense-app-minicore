  ...
  return (
    <div className="min-h-screen bg-background font-sans">
      <div className="container mx-auto px-4 py-8">
        <h1 className="text-4xl font-bold mb-8">Sistema de Gestión de Gastos</h1>
        ...
        <div className="grid gap-8">
          ...
          <div className="grid gap-8 lg:grid-cols-2">
            <div className="p-6 bg-card rounded-lg shadow-sm">
              <h2 className="text-2xl font-semibold mb-4">Gastos por Departamento</h2>
              <ExpensesTable expenses={expenses} isLoading={isLoading} />
            </div>

            <div className="p-6 bg-card rounded-lg shadow-sm">
              <h2 className="text-2xl font-semibold mb-4">Gráfico de Gastos</h2>
              {expenses.length > 0 ? (
